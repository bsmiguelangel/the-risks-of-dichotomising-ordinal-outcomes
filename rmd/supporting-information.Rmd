---
title: 'Supporting information for "The risks of dichotomising ordinal outcomes: A spatial analysis of self-rated health in Western Europe"'
author: | 
 | Miguel Ángel Beltrán-Sánchez$^a$; Miguel Ángel Martínez-Beneito$^a$; Terje Eikemo$^b$; 
 | Sara Martino$^c$; Andrea Riebler$^c$ 
 | \small $^a$Department of Statistics and Operational Research, University of Valencia, Burjassot, Spain 
 | \small $^b$Department of Sociology and Political Science, Norwegian University of Science and Technology, Trondheim, Norway 
 | \small $^c$Department of Mathematical Sciences, Norwegian University of Science and Technology, Trondheim, Norway
output:
  pdf_document:
    keep_tex: true
    includes:
...
knitr::opts_chunk$set(echo = TRUE, fig.align = "center", out.width = "\\textwidth",
...
#                      HMC = TRUE, parallel = TRUE)
# 
# saveRDS(salnimble, file = file.path("..", "results", paste0("bernoulli-leroux-hmc-waic-", gender, "-d2.rds")))
```
...
#                      HMC = TRUE, parallel = TRUE)
# 
# saveRDS(salnimble, file = file.path("..", "results", paste0("bernoulli-leroux-hmc-waic-", gender, "-d3.rds")))
```
...
bernoulli_results1 <- readRDS(file = file.path("..", "results", paste0("bernoulli-leroux-hmc-waic-", gender, "-d2.rds")))
# Logistic regression (Option 2): 0 = First three categories; 1 = Last two categories.
bernoulli_results2 <- readRDS(file = file.path("..", "results", paste0("bernoulli-leroux-hmc-waic-", gender, "-d3.rds")))
```
